...
- **Even G2 voice (private deployment)** - Version 0.4.0 streams local speech recognition, pauses on a reviewable draft until explicit confirmation, and shows session turns in a continuous conversation feed. See [the plugin guide](evenhub/README.md).
