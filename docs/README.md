...
| [evenhub-streaming-protocol.md](evenhub-streaming-protocol.md)           | Private EvenHub authenticated streaming protocol                          |
| [evenhub-streaming-stt-benchmark.md](evenhub-streaming-stt-benchmark.md) | Physical G2/Moonshine benchmark gate                                      |
...
| [evenhub-tailscale-deployment.md](evenhub-tailscale-deployment.md)       | Primary tailnet-only EvenHub 0.4.4 deployment                             |
